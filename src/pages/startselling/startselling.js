...
const cardData = [
  {
    ...
    content:
      "PLorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard...",
  },
  {
    img: "images/step2.svg",
    title: " Complete the vehicle data",
    content:
      "PLorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard...",
  },
  {
    img: "images/step3.svg",
    title: "  Create a full description of the advertisement",
    content:
      "PLorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard...",
  },
  {
    img: "images/step4.svg",
    title: " Add attractive photos",
    content:
      "PLorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard...",
  },
  {
    img: "images/step5.svg",
    title: " Promote the advertisement",
    content:
      "PLorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard...",
  },
  {
    img: "images/step6.svg",
    ...
    <div>
      ...
      <div className={styles["startSelling"]}>
        ...
        <div className={styles["timeline"]}>
          <div className={`${styles["container"]} ${styles["left-container"]}`}>
            ...
            <div className={styles["text-box"]}>
              ...
              <p>
                Click “ Add ” in the upper right corner of the page and log in
                to the Business Account. Please note that the default category
                for the new announcement is “ Passenger cars ”. If you want to
                change it, expand the list and select the appropriate category.
              </p>
          ...
          >
            ...
            <div className={styles["text-box"]}>
              ...
              <span className={styles["right-container-arrow"]}></span>
            </div>
          </div>
        ...
        <div className={styles["addSection"]}>
          <div className={styles["heading"]}>
            <h2> Steps to create a perfect advertisement</h2>
          </div>
                ...
                {questions.map((question, index) => (
                  ...
                  >
                    <div className={styles["question"]}>
                      <h3 className={styles["title__question"]}>{question}</h3>
